// Sample course data for the instructor dashboard
export const instructorCourseData = [
  {
    id: 1,
...
export const instructorCourseCategories = [
  "Web Development",
  "Mobile Development",
  "Data Science",
  "Machine Learning",
...
export const instructorCourseLevels = [
  "beginner",
  "intermediate", 
  "advanced"
];